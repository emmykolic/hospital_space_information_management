          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">Register Supervisor</h2>
                <div class="module-subtitle font-serif">fill the form below to create a supervisor account.</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <form role="form" method="post" action="add_supervisor_action.php">
                  ...
                  <div class="form-group">
                    <label class="sr-only" for="mat_no">Staff ID</label>
